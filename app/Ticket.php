 ...
 * @method static \Illuminate\Database\Eloquent\Builder|\App\Ticket whereClosedAt($value)
 * @method static \Illuminate\Database\Eloquent\Builder|\App\Ticket whereClosedBy($value)
...
class Ticket extends Model
{
     ...
     * @return Builder
     */
    public function scopeFilterByTag($q, $tagId)
    {
        return $q->whereHas('tags', function(Builder $query) use($tagId) {
            $query->where('tag_id', (int) $tagId);
        });
    }
